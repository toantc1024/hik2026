...
export default class ImageFrameRenderer {
    ...
    drawFrameOnCanvas(canvas, uploadedImg, uploadedImgLoaded, formData, canvasSize, imageSettings = { x: 0, y: 0, size: 1200 }) {
    ...
    drawAvatarFrameOnCanvas(canvas, uploadedImg, uploadedImgLoaded, canvasSize, imageSettings = { x: 0, y: 0, size: 1200 }) {
        const ctx = canvas.getContext("2d", { alpha: true });
    ...
    createHighResolutionImage(uploadedImg, uploadedImgLoaded, formData, imageSettings = { x: 0, y: 0, size: 1200 }) {
    ...
    createHighResolutionAvatarImage(uploadedImg, uploadedImgLoaded, imageSettings = { x: 0, y: 0, size: 1200 }) {
        return new Promise((resolve, reject) => {
            try {
                const exportCanvas = document.createElement("canvas");
                const exportCtx = exportCanvas.getContext("2d", { alpha: true });
